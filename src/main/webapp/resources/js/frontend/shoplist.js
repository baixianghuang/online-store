$(function () {
    ...
    function addItems(pageSize, pageIndex) {
        ...
        $.getJSON(url, function (data) {
            if (data.success) {
                ...
                // get the number of cards that have been loaded
    ...
    $('.shop-list').on('click', '.card', function (e) {
        ...
        window.location.href = '/online_store/frontend/shopdetail?shopId=' + shopId;
    });
