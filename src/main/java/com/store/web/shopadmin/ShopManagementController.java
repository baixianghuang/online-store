...
public class ShopManagementController {
    ...
    private Map<String, Object> getShopManagementInfo(HttpServletRequest request) {
        ...
        if (shopId <= 0) {
            ...
            if (currentShopObj == null) {
                ...
                modelMap.put("url", "/online_store/shopadmin/shoplist");
            } else {
    ...
    private Map<String,Object> getShopList(HttpServletRequest request) {
        ...
        try {
            ...
            // pageSize is actually the max number of shop a person can create
    ...
    private Map<String,Object> getShopById(HttpServletRequest request) {
        ...
        if (shopId > -1) {
            try {
                ...
                List<Area> areaList = areaService.getAreaList();  // Note that owner can't update shop category
...
//            }
            ...
            modelMap.put("success", false);
            modelMap.put("errMsg", "Must input valid shop information");
            return modelMap;
        }
    }
    ...
    private Map<String,Object> modifyShop(HttpServletRequest request) {
        ...
        if (shop != null && shop.getShopId() != null) {
            ...
            modelMap.put("success", false);
            modelMap.put("errMsg", "Must input valid shopId");
            return modelMap;
        }
    }

    // Changing the image parameter of addShop() from File into InputStream is more efficient
    // This method convert inputStream to File before the change
...
//            }
//        } catch (Exception e) {
//            throw new RuntimeException("Error on invoking inputStreamToFile, " + e.getMessage());
//        } finally {
//            try {
//                if (os != null) { os.close(); }
//                if (ins != null) { ins.close(); }
//            } catch (IOException e) {
//                throw new RuntimeException("Error on closing inputStreamToFile's I/O, " + e.getMessage());
//            }
//        }
//    }
}
